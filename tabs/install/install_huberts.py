...
def install_hubert_tab():
    with gr.Tab('Установка HuBERT моделей'):
        ...
        with gr.Row(variant='panel'):
            ...
            hubert_model_dropdown = gr.Dropdown(list(models.keys()), label='HuBERT модели:', visible=True)
        ...
        custom_url_checkbox.change(toggle_custom_url, inputs=custom_url_checkbox, outputs=[custom_url_textbox, hubert_model_dropdown])

    hubert_download_btn.click(download_and_replace_model, inputs=[hubert_model_dropdown, custom_url_textbox], outputs=hubert_output_message)
