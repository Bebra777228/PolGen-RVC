            ...
            with gr.Group():
                with gr.Column(variant="panel"):
                    ...
                    hop_length = gr.Slider(
                        ...
                        visible=False,
                        label="Длина шага",
                        info="Меньшие значения приводят к более длительным "
                        "преобразованиям, что увеличивает риск появления "
                        "артефактов в голосе, однако при этом достигается "
                        "более точная передача тона.",
                    )
                    f0_method.change(
