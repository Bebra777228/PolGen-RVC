...
def perform_voice_conversion(
    voice_model, input_path, output_path, pitch, f0_method, index_rate, filter_radius, volume_envelope, protect, hop_length, f0_autotune, f0_autopitch, f0_min, f0_max
):
    ...
    rvc_infer(
        rvc_index_path, index_rate, input_path, output_path, pitch, f0_method, cpt, version, net_g, filter_radius,
...
def tts_pipeline(
    ...
    perform_voice_conversion(
        voice_model, tts_output_path, final_output_path, pitch, f0_method, index_rate, filter_radius,
