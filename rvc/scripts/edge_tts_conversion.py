...
def voice_conversion(voice_model, input_path, output_path, pitch, **conversion_params):
    ...
    rvc_infer(rvc_index_path, input_path, output_path, cpt, version, net_g, tgt_sr, vc, hubert_model, pitch, **conversion_params)
    del hubert_model, cpt, net_g, vc
    gc.collect()
    torch.cuda.empty_cache()

def edge_tts_pipeline(text, voice_model, voice, pitch, output_format, progress=gr.Progress(), **conversion_params):
    ...
    voice_conversion(voice_model, tts_voice_path, tts_voice_convert_path, pitch, **conversion_params)
