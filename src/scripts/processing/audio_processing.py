...
def combine_audio(vocal_path, instrumental_path, output_path, vocal_gain, instrumental_gain, output_format):
    try:
        ...
        logging.error(f"Ошибка при объединении аудио: {e}")
        raise
...
def apply_effects(vocal_path, output_path, reverb_rm_size, reverb_wet, reverb_dry, reverb_damping, reverb_width,
    ...
    try:
        ...
        logging.error(f"Ошибка при применении эффектов: {e}")
        raise
...
def processing(vocal_audio_path, instrumental_audio_path, reverb_rm_size, reverb_wet, reverb_dry, reverb_damping, reverb_width,
    ...
    try:
        ...
        if use_effects:
            ...
            apply_effects(stereo_vocal_path, vocal_output_path, reverb_rm_size, reverb_wet, reverb_dry, reverb_damping, reverb_width,
                          low_shelf_gain, high_shelf_gain, compressor_ratio, compressor_threshold, noise_gate_threshold, noise_gate_ratio,
