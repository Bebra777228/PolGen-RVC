...
def perform_voice_conversion(voice_model, input_path, output_path, pitch, f0_method, index_rate, filter_radius, volume_envelope, protect, hop_length, f0_autotune, f0_min, f0_max):
    ...
    rvc_infer(rvc_index_path, index_rate, input_path, output_path, pitch, f0_method, cpt, version, net_g,
...
def tts_pipeline(text, voice_model, voice, pitch, index_rate=0.5, filter_radius=3, volume_envelope=0.25, f0_method='rmvpe',
    ...
    perform_voice_conversion(voice_model, tts_output_path, final_output_path, pitch, f0_method, index_rate,
