...
def welcome_tab():
    gr.HTML("<center><h1>Добро пожаловать в CoverGen Lite - Politrees (v1.0)</h1></center>")
    with gr.Row():
    ...
    with gr.Column(variant='panel'):
        gr.HTML("<center><h2>Спасбибо <a href='https://t.me/Player1444'>Player1444</a> за помощь в тестах.</h2></center>")
