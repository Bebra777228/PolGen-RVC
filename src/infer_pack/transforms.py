...
def rational_quadratic_spline(
    ...
    if min_bin_width * num_bins > 1.0:
        raise ValueError("Минимальная ширина бина слишком велика для количества бинов")
    if min_bin_height * num_bins > 1.0:
        raise ValueError("Минимальная высота бункера слишком велика для количества бункеров")
